...
import AnnotationIcon from "images/annotate.svg";
import TrainingIcon from "images/brain.png";
import PredictionIcon from "images/image-processing.png";
...
const Column = styled.div`
  ${tw`w-full md:w-1/3 max-w-sm p-2`} // Adjust padding as needed for spacing
`;
...
export default ({
    ...
    const defaultCards = [
      { imageSrc: AnnotationIcon, title: "Annotation Projects", link: "/CreateProject" },
      { imageSrc: TrainingIcon, title: "Model Training", link: "/TrainModel" },
      { imageSrc: PredictionIcon, title: "Model Predictions", link: "/predictions" },
    ];
