...
const TwoColumn = tw.div`flex flex-wrap text-center sm:text-left justify-between sm:justify-start md:justify-center -mt-12 space-x-4`; // Centered for md, added space-x-4
      ...
      <Content>
        ...
        <ThreeColRow>
          <LogoContainer>
            ...
            <LogoText>PathoSync</LogoText>
          </LogoContainer>
          <CopywrightNotice>&copy; 2023 PathoSync Inc. All Rights Reserved.</CopywrightNotice>
