...
valid_generator = valid_datagen.flow_from_directory(valid_dir,
                                                    ...
                                                    seed=42,
                                                    color_mode='rgb')
# Print out the number of classes for debugging
print("Number of classes according to your script:", num_of_classes)
print("Number of classes expected based on generator classes:", len(train_generator.class_indices))
